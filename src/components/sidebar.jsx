...
const Sidebar = () => {
    ...
    return (
        <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div className="flex items-center justify-between p-4 bg-white border-b dark:bg-gray-900 dark:border-gray-800">
                <a href="#" className="text-lg font-semibold text-gray-800 dark:text-white">Kia Computer</a>
                <button onClick={() => setIsOpen(!isOpen)} className="text-gray-800 dark:text-white cursor-pointer hover:background-gray-100 dark:hover:bg-gray-800 rounded-lg p-2   focus:outline-none">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 bg-white border-t dark:bg-gray-900 dark:border-gray-800">
                <button className="w-full py-2 text-sm font-semibold text-white bg-red-500 rounded-lg focus:outline-none focus:ring focus:ring-blue-300">
                    Logout
                </button>
            </div>
        </aside>
